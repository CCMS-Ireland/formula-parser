import { executeFunction, executeOperator } from '../src/supportedFunctions';
...
tests.push([
  'if',
  ['anything except 0 and empty string', 'first', 'second'],
  'first',
]);
...
describe('supported functions', () => {
  test.each(tests)(
    'evaluate %s function with %s params and get %s',
